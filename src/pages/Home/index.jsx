...
export default function Home() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentSlideRight((prevSlide) => (prevSlide - 1 + slides.length / 3) % (slides.length / 3));
    }, 2000);
            ...
            <ContainerBody> 
                ...
                <Service>
                    <TitleService>
                        ...
                        <p>A Festas oferece uma ampla gama de serviços de ornamentação e decoração para diversos tipos de eventos especiais. Seja para uma formatura, casamento, aniversário, festa temática ou qualquer outra ocasião especial, estamos aqui para transformar seu evento em um momento inesquecível.</p>
                    </TitleService>                    
                    <ServiceTypes>
                        <CardServiceTypes>
                ...
                <Carrosel>
                  ...
                  <CarouselContainer>
                    {slides.map((slide, index) => (
                      <Slide key={index} style={{ transform: `translateX(-${currentSlideLeft * 200}px)` }}>
                  ...
                  <CarouselContainer>
                    {slides.map((slide, index) => (
                      <Slide key={index} style={{ transform: `translateX(-${currentSlideRight * 200}px)` }}>
                        <SlideImage src={slide.photo} alt={`Slide ${index + 1}`} />
                      </Slide>
                    ))}
                  </CarouselContainer>
